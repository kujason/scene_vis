...
class VtkVoxelGrid:
    """
    VtkVoxelGrid uses cubes from a vtkCubeSource to
     visualize voxels from a VoxelGrid object. Scalar arrays such as height
     or point density can also be added and visualized.
    """
    ...
    def set_voxels(self, voxel_grid):
        ...
        :param VoxelGrid voxel_grid: voxel grid
        """
    ...
    def set_scalar_array(self, scalar_name, scalars, scalar_range=None):
        ...
        :param scalar_name: str name of scalar array, used as dictionary key
        :param scalars: 1D array of scalar values corresponding to each cell
        :param scalar_range: Custom range if desired
        """
        ...
        vtk_scalar_array = \
            numpy_support.numpy_to_vtk(remapped_scalar_values,
                                       deep=True,
                                       array_type=vtk.VTK_TYPE_FLOAT32)
    ...
    def set_active_scalars(self, scalar_name):
        """
        Sets the active scalar array

        :param scalar_name: Dictionary key corresponding to desired scalar array
        """
