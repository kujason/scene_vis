...
def create_gt_vtk_boxes(easy_gt_objs, medium_gt_objs, hard_gt_objs, all_gt_objs, show_orientations):
...
def get_experiment_info(checkpoint_name):
    exp_output_base_dir = md3d.data_dir() + '/outputs/' + checkpoint_name
